...
const slideNames = [
  "domain-map", "authority-ladder", "stable-prefix", "placement-map",
  "literal-models", "few-shot", "untrusted-data", "context-decay",
  "three-controls", "compaction-trap", "tool-pruning", "subagent-isolation",
  "output-layers", "defensive-parse", "structured-modes", "schema-boundaries",
  "failure-tree", "meeting-question"
];
