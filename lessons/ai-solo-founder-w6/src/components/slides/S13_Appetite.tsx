...
export default function S13_Appetite() {
	return <Slide bg={colors.yellow}><Inner split>
		...
		<Half><Card bg={colors.white}><p style={{ fontSize: 22, lineHeight: 1.7 }}><strong>Estimate：</strong>从想做的方案出发，预测它需要多久。<br /><br /><strong>Appetite：</strong>先规定值得投入多少时间，再设计装得下的方案。</p><div style={{ marginTop: 22, padding: 16, background: colors.green, fontSize: 21, fontWeight: 900 }}>OPC：先看日历，再谈范围。</div></Card></Half>
	</Inner></Slide>;
}