...
const plans = [
	{
		name: 'Self-paced', price: '$599', color: '#f5f5f5', textColor: colors.black,
		features: ['录播视频', 'Lab 实操', 'AI 自动评分', '社群访问'], badge: null,
	},
	{
		name: 'Cohort', price: '$1,299', color: colors.indigo, textColor: '#fff',
		features: ['以上全部 +', '每周直播授课', '每周直播答疑', '老师 Code Review', 'Cohort 社区'], badge: '推荐',
	},
	{
		name: 'Premium', price: '$2,499', color: colors.dark, textColor: '#fff',
		features: ['以上全部 +', '1v1 Coaching', '项目深度指导', 'Demo Day 优先展示', '求职推荐'], badge: 'VIP',
	},
];
		...
		<Slide bg="#f0f4ff">
			<Inner center>
					...
					{plans.map((p, i) => (
						...
						>
							...
							<div style={{ padding: '28px 24px', textAlign: 'center' }}>
								...
								<div style={{ fontSize: 14, opacity: 0.7 }}>AUD / 12 周</div>
				...
				<div style={{ marginTop: 20, fontSize: 15, color: '#666' }}>
					早鸟优惠: Cohort <strong>$999</strong> | Premium <strong>$1,999</strong> (首期限定)
				</div>
			</Inner>
		</Slide>
	);
