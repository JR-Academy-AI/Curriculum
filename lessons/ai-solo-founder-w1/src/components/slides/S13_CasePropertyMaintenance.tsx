			...
			<Body style={{ padding: '34px 54px 28px' }}>
				...
				<DeckTable
					...
					rows={[
						...
						[f('2', '客户 Job 假设'), '当报修资料混乱时，想一次收齐可分派信息，从而减少追问又不漏紧急事项（待验证）。'],
						[f('3', '现有替代与代价'), '经理在邮件 / 短信 / 表格间复制，再凭经验分派；漏单率与工时 unavailable。'],
						[f('4', '最小结果与交付'), '将一条脱敏报修记录整理成待经理批准的结构化工单草稿。'],
						[f('5', 'AI / 人的边界'), 'AI 整理信息、追问缺失项、生成草稿；经理确认紧急等级、供应商和费用。'],
						[f('6', '6 周可推翻证据'), '观察 20 个历史工单 → 访谈 5 位经理 → 至少 1 位愿意付试点费；否则修改或停止。'],
