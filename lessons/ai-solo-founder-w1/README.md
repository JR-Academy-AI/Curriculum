...
| **07 每周 Founder Skills** | 逐周展示真实 Skill 名及可完成的具体结果；Founder OS 读取前一周证据继续推进 | `../../ai-solo-founder-bootcamp/skills/opc-business-sot/SKILL.md` + `../../ai-solo-founder-bootcamp/skills/opc-agent-team/SKILL.md` 至 `opc-w15-graduation-auditor/SKILL.md` |
