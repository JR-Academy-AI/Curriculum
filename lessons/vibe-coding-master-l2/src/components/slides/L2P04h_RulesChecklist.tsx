...
// 13 条可写进 CLAUDE.md / .cursor/rules 的具体规则（比 SOLID/DRY/KISS 更落地）
...
// Rules Checklist：13 条可执行规则，比 SOLID/DRY/KISS 更具体、可直接抄进 rules 文件
			...
			<Inner style={{ flexDirection: 'column' }}>
				<motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35 }}>
					...
					<Title size="40px" style={{ marginTop: 10 }}>
						13 条可执行规则：<span style={{ color: colors.red }}>比 SOLID/DRY/KISS 更具体</span>
					</Title>
					<p style={{ fontSize: 14.5, color: '#555', marginTop: 6, fontWeight: 700 }}>
						SOLID/DRY/KISS 是方向，这 13 条是可以直接抄进 CLAUDE.md / .cursor/rules 的具体条款。
					</p>
				</motion.div>
