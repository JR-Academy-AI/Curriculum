...
对着国内 AI 应用开发岗的真实 JD 学，12 周从零做出「匠答 AI」电商智能客服工单系统，毕业带着扛得住面试追问的真项目，冲 25-40K 应用开发岗。

**级别** 中级进阶 · **类型** training · **时长** 12 周技术 + 职业孵化（每周 2 节直播 ≤3h，录播 + Lab + Quest 自主节奏） · **总课时** 61 · **步骤** 154 · **直播** 24 · **互动 Lab** 18 · **预计学时** 96

**适合**：有编程基础、想转 AI 应用开发的后端/全栈工程师，以及拼 AI 校招的应届生、想补 LLM 工程能力的算法/数据岗

**目标**：掌握国内 AI 应用开发岗所需的全栈工程能力：国产大模型 API、Prompt/Function Calling、RAG 工程化、Agent + MCP、微调与私有化部署、AI 评测与安全，全部在「匠答 AI」电商智能客服工单系统上落地。

---

## P0 — 工程地基（第 1 周）

_摸底 + 国产开发环境 + 本地跑通匠答 AI_

- **Pre-work：先修要求与国产开发环境** — 50 分钟
- **Lab: Python 工程化基础** — 30 分钟
- **Lab: FastAPI 起一个服务** — 30 分钟
- **Lab: Git 分支与 PR** — 30 分钟
- **【直播 W1-1】训练营导览 + 匠答 AI 架构拆解** — 180 分钟 · 🔴直播
- **【直播 W1-2】Docker Compose 本地一键启动陪跑** — 120 分钟 · 🔴直播
- **Quest：本地跑通匠答 AI** — 60 分钟

## P1 — 大模型应用基础（第 2 周）

_国产大模型 API · Prompt · Function Calling · 接进匠答 AI_

- **国产大模型全景与选型** — 45 分钟
- **【直播 W2-1】国产大模型 API 接入匠答 AI** — 150 分钟 · 🔴直播
- **Lab: Prompt 四要素与结构化输出** — 30 分钟
- **Lab: JSON Schema 受控输出** — 30 分钟
- **【直播 W2-2】Function Calling + 第一个订单查询 Function Call** — 150 分钟 · 🔴直播
- **扣子 Coze / Dify 低代码编排速览** — 30 分钟
- **Quest：匠答 AI 接国产模型 + 跑通首个 Function Call** — 60 分钟

## P2 — RAG 工程化（第 3-5 周）

_Embedding · 向量库 · RAG Pipeline · 混合检索 · RAG 评测 · 接进客服应答决策_

- **【直播 W3-1】Embedding 与向量化原理** — 120 分钟 · 🔴直播
- **向量库选型：Milvus / Chroma / pgvector** — 40 分钟
- **Lab: 文本向量化与相似检索** — 30 分钟
- **【直播 W3-2】给匠答 AI 建客服知识库** — 150 分钟 · 🔴直播
- **Lab: 文档分块与索引** — 30 分钟
- **【直播 W4-1】RAG Pipeline 全流程 + 混合检索** — 180 分钟 · 🔴直播
- **Lab: 混合检索 + Rerank** — 30 分钟
- **Lab: 查询重写与上下文压缩** — 30 分钟
- **【直播 W4-2】把 RAG 接进客服应答决策** — 150 分钟 · 🔴直播
- **PDF / 工单文档解析实战** — 30 分钟
- **【直播 W5-1】RAG 评测体系：RAGAS / Langfuse** — 150 分钟 · 🔴直播
- **Lab: 搭建 RAG 评测面板** — 30 分钟
- **【直播 W5-2】成本、限流与缓存优化** — 120 分钟 · 🔴直播
- **Quest：给匠答 AI 接私有知识库 + 跑出评测指标** — 90 分钟
...
- **【直播 W7-2】用 MCP 接匠答 AI 后端 API** — 150 分钟 · 🔴直播
- **MCP 生态与发布指南** — 25 分钟
- **【直播 W8-1】Multi-Agent 架构与工作流编排** — 150 分钟 · 🔴直播
- **Lab: 多智能体协作** — 30 分钟
- **【直播 W8-2】升级成多智能体协作客服** — 150 分钟 · 🔴直播
- **Quest：匠答 AI 的 AI 大脑 = Agent + MCP** — 90 分钟
