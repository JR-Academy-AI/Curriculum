...
// 封面：Vibe Coding 大师课 · 第五节课 —— Skills
export default function L5P00_Cover() {
	const chips = ['重复 Prompt', 'SKILL.md', '一句话调用', '迭代'];
	return (
			...
			<Inner center>
				<div style={{ textAlign: 'center' }}>
					...
					<motion.div
						...
						<span style={{ fontSize: 18, fontWeight: 700 }}>前四节教 AI 该做什么、怎么交付；这节让它把套路变成自己的能力</span>
					</motion.div>
