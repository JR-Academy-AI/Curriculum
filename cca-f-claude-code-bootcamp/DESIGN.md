...
价格**待定**。`outline.json` 里现填的 `tuition: 1699 / promoTuition: 1299` 是占位建议价，**未定稿**。定价锚点：直通包 US$399 / 首期 US$299（含名额），本课在其之上加 8 场直播 + 40h 真实环境实战 + 答疑。定稿后回填 `program.tuition`，并与直通包一致用 **USD** 币种。
