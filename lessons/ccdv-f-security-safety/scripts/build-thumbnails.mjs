...
const slideNames = [
  "weight", "request-control", "attack-surface", "weak-defenses",
  "three-layer", "injection-vs-jailbreak", "guardrail-stack", "least-privilege",
  "pii-boundary", "pre-post", "refund-gate", "secret-config",
  "auth-headers", "authorization", "refusal", "ticket-question"
];
