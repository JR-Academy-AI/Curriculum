...
const slideNames = [
  "weight", "description", "symmetric", "schema", "granularity", "tool-choice",
  "any-loop", "error-matrix", "empty-result", "client-server", "four-ways",
  "decision-tree", "mcp-roles", "transports", "primitives", "scopes",
  "routing-debug", "mcp-question"
];
