...
const slideNames = [
  "format", "domain-weights", "top-skills", "time-budget", "two-weeks",
  "four-traps", "overbuild", "constraints", "source-fix", "deterministic",
  "repeats", "numbers", "stop-reasons", "http", "breaking", "mcp-tools",
  "eight-lines", "exam-loop"
];
