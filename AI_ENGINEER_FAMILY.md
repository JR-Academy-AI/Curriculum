...
- 买了「进阶 $1999」→ 🟡 **别单卖，直接推合集 $2180**（只贵 $181 就多一门 $299 的课）。见 Q2。
...
换出来的真问题是：这条线上有**三个价位重叠的视频课**——入门 $299 / 进阶 $1999 / 入门+进阶合集 $2180。合集只比进阶贵 $181，等于**单买进阶几乎没有理由**（花 $181 白得一门 $299 的入门课）。这个定价关系是有意设计的锚定，还是没人对过账，需要确认。
...
| G1c | **视频课三件套定价重叠**（合集 $2180 仅比进阶 $1999 贵 $181，单买进阶无理由） | 定价锚定可能失效，学员困惑 | 🔴 P0 | Ada 核对是否有意设计 |
