  ...
  const renderDocument = (coverSrc, logoSrc, art) => {
    ...
    pages.push(`<section class="page cover-page" data-page="1">
      ...
      <div class="cover-content">
        ...
        <span class="cover-kicker">SYSTEMATIC AI ENGINEERING EDUCATION</span>
        <h1 class="cover-title">AI ENGINEER<br/>BOOTCAMP</h1>
        <span class="cover-cohort">第七期 · COHORT 07</span>
        <h2 class="cover-positioning">全球少有的<em>系统化 AI 工程课程</em></h2>
        <p class="cover-subtitle">从 LLM 原理、Context、RAG 到 Agent、Memory、Harness、Governance、Model Routing 与 Evaluation，建立从基础到 Production 的完整能力体系。</p>
        <div class="cover-proof"><span>12 场理论 Live</span><span>13 场独立实践 Live</span><span>10 层 AI 工程技术栈</span><span>13 周 Production 项目主线</span></div>
        <div class="cover-system"><strong>不是工具合集，而是一套完整工程体系</strong><p>LLM · CONTEXT · RAG · MCP · AGENTS · MEMORY · HARNESS · GOVERNANCE · MODEL ROUTING · EVALUATION</p></div>
      </div>
