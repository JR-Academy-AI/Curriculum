...
const rows = [
	{ name: 'DeepLearning.AI', price: '~$50', duration: '自学', projects: '❌', live: '❌', bilingual: '❌', career: '❌', agentEval: '❌' },
	{ name: 'Udacity AI Nanodegree', price: '$399/月', duration: '3-4 月', projects: '部分', live: '❌', bilingual: '❌', career: '有限', agentEval: '❌' },
	{ name: 'Coursera ML Spec', price: '~$50/月', duration: '自学', projects: '❌', live: '❌', bilingual: '❌', career: '❌', agentEval: '❌' },
	{ name: 'Bootcamp.ai / AI Camp', price: '$5K-15K', duration: '12+ 周', projects: '✅', live: '✅', bilingual: '❌', career: '✅', agentEval: '部分' },
	{ name: 'LinkedIn Learning', price: '$40/月', duration: '碎片化', projects: '❌', live: '❌', bilingual: '❌', career: '❌', agentEval: '❌' },
];
			...
			<Inner center>
				...
				<div style={{ width: '100%', maxWidth: 1200, marginTop: 8 }}>
					<table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
						<thead>
							<tr>
								{['竞品', '价格', '时长', '项目', 'Live 直播', '中英双语', '职业支持', 'Agent+Eval'].map(h => (
						...
						<tbody>
							...
							<tr style={{ background: colors.yellow }}>
								...
								<td style={tdS}>✅ 全套</td>
								<td style={tdS}>✅ Agent+Eval</td>
							</tr>
						</tbody>
					</table>
				</div>
				<div style={{ marginTop: 20, display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center' }}>
					{['中英双语', '7 实战项目', 'RAG + GraphRAG + Agent SDK', 'Fine-Tuning + Eval', 'Cohort + 导师', 'P3 + 求职'].map((t, i) => (
