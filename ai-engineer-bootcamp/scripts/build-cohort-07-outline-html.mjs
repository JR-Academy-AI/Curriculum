...
.cover-rarity{display:inline-flex;margin-top:13mm;color:#7957ff;font-size:7.6pt;font-weight:750;letter-spacing:.035em}.cover-page .cover-positioning{margin-top:4mm}.cover-page .cover-positioning span{display:block;color:#101a3a;font-size:19pt;line-height:1}.cover-page .cover-positioning em{margin-top:2mm;font-size:23pt}.cover-page .cover-subtitle{font-size:9pt}.cover-page .cover-proof{margin-top:7mm}.cover-page .cover-system strong{font-size:11pt}.cover-page .cover-system p{max-width:150mm;font-size:6.5pt;line-height:1.35}
